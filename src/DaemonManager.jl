#!/usr/bin/env julia
"""
DaemonManager.jl - Integrated daemon lifecycle management for JMake
...
Start all JMake daemons with integrated process management.
...
function start_all(;project_root=pwd(), log_dir=joinpath(project_root, "daemons", "logs"))
    println("="^70)
    println("Starting JMake Daemon System")
    println("="^70)
...
function stop_all(system::DaemonSystem)
    println("\n" * "="^70)
    println("Stopping JMake Daemon System")
    println("="^70)
